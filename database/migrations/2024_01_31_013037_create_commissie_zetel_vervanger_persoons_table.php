...
return new class extends Migration
{
    ...
    {
        Schema::create('commissie_zetel_vervanger_personen', function (Blueprint $table) {
            $table->id();
            $table->text('openData_id');
            $table->text('commissieZetel_id');
            $table->text('persoon_id')->nullable();
    ...
    {
        Schema::dropIfExists('commissie_zetel_vervanger_personen');
    }
};
