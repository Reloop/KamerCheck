...
return new class extends Migration
{
    ...
    {
        Schema::create('persoon_loopbanen', function (Blueprint $table) {
            $table->id();
            $table->text('openData_id');
            $table->text('functie')->nullable();
            $table->text('werkgever')->nullable();
            $table->text('omschrijvingNl')->nullable();
            $table->text('omschrijvingEn')->nullable();
    ...
    {
        Schema::dropIfExists('persoon_loopbanen');
    }
};
